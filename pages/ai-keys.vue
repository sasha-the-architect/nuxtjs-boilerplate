...
useSeoMeta({
  ...
  ogUrl: `${runtimeConfig.public.siteUrl || runtimeConfig.public.canonicalUrl || process.env.NUXT_PUBLIC_URL || process.env.CANONICAL_URL || 'http://localhost:3000'}/ai-keys`,

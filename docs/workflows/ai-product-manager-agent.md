# AI Product Manager Agent Workflow

## File Konfigurasi
**Nama File**: `.github/workflows/ai-product-manager-agent.yml`

## Deskripsi
Product Manager Agent adalah agen AI yang bertindak sebagai Product Manager untuk startup AI. Agen ini bertanggung jawab atas roadmap produk, prioritas fitur, user experience, dan kesuksesan produk di pasar.

## Jadwal Eksekusi
- **Waktu**: 09:30 UTC setiap hari
- **Frekuensi**: Harian
- **Prioritas**: Tinggi
      ...
      - name: Run Product Manager Agent
        ...
        run: |
          opencode run "$(cat <<'PROMPT'
            ...
            Gunakan git config user.name "ai-product-manager-agent" dan git user.email "ai-product-manager@startup.ai" untuk semua commit.
            ...
            Alasan: Kemampuan analisis produk yang mendalam, pemahaman user behavior, dan kemampuan strategic thinking untuk product development.
...
1. **Product Performance Report**: Laporan komprehensif metrik produk
2. **Updated Backlog**: Product backlog yang diprioritaskan dengan jelas
3. **User Insights Summary**: Key findings dari user research dan feedback
4. **Roadmap Updates**: Pembaruan roadmap produk dengan rationale
5. **Development Tasks**: User stories yang siap untuk implementasi

## Kriteria Sukses

- Produk memenuhi kebutuhan user dan memberikan value yang tinggi
- Roadmap produk teralign dengan strategi bisnis
- Prioritas fitur didasarkan pada data dan insight user
- Kolaborasi cross-functional berjalan efektif
- Product metrics menunjukkan pertumbuhan yang positif

## Monitoring dan Evaluasi

- Track product KPI (DAU, retention, conversion, satisfaction)
- Monitor velocity pengembangan produk
- Evaluasi quality user stories dan acceptance criteria
- Assessment effectiveness product decisions
- Review alignment product dengan business goals
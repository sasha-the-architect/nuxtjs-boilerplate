# AI CFO Agent Workflow

## File Konfigurasi
**Nama File**: `.github/workflows/ai-cfo-agent.yml`

## Deskripsi
CFO Agent adalah agen AI yang bertindak sebagai Chief Financial Officer untuk startup AI. Agen ini bertanggung jawab atas keuangan perusahaan, perencanaan finansial, investasi, dan strategi monetisasi.

## Jadwal Eksekusi
- **Waktu**: 10:00 UTC setiap hari
- **Frekuensi**: Harian
- **Prioritas**: Tinggi
      ...
      - name: Run CFO Agent
        ...
        run: |
          opencode run "$(cat <<'PROMPT'
            ...
            Alasan: Kemampuan analisis finansial yang kuat, pemahaman kompleksitas financial modeling, dan kemampuan strategic financial planning.
...
1. **Daily Financial Summary**: Laporan komprehensif performa finansial harian
2. **Budget Analysis**: Analisis pengeluaran terhadap anggaran
3. **Cash Flow Projection**: Proyeksi cash flow dan runway analysis
4. **Financial Recommendations**: Rekomendasi strategis untuk optimasi finansial
5. **Updated Financial Models**: Model finansial yang diperbarui dengan data terbaru

## Kriteria Sukses

- Kesehatan finansial perusahaan terjaga dengan baik
- Cash flow dan runway teroptimasi
- Budget compliance dan cost efficiency tercapai
- Strategic financial decisions didukung oleh data yang solid
- Investor relations dan funding preparation terkelola dengan baik

## Monitoring dan Evaluasi

- Track key financial KPI (revenue growth, burn rate, runway, profitability)
- Monitor budget variance dan compliance
- Evaluasi accuracy financial forecasts
- Assessment ROI dari investments dan initiatives
- Review effectiveness financial strategies dan decisions
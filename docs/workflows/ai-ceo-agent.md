# AI CEO Agent Workflow

## File Konfigurasi
**Nama File**: `.github/workflows/ai-ceo-agent.yml`

## Deskripsi
CEO Agent adalah agen AI yang bertindak sebagai Chief Executive Officer untuk startup AI. Agen ini bertanggung jawab atas pengambilan keputusan strategis, arah perusahaan, dan koordinasi eksekutif.

## Jadwal Eksekusi
- **Waktu**: 08:00 UTC setiap hari
- **Frekuensi**: Harian
- **Prioritas**: Tertinggi
      ...
      - name: Run CEO Agent
        ...
        run: |
          opencode run "$(cat <<'PROMPT'
            ...
            Alasan: Kemampuan analisis strategis, pemahaman konteks bisnis yang mendalam, dan kemampuan pengambilan keputusan kompleks.
...
1. **Executive Summary Harian**: Laporan komprehensif performa perusahaan
2. **Strategic Directives**: Arahan jelas untuk agen lain
3. **Decision Documentation**: Rationale di balik keputusan strategis
4. **Roadmap Updates**: Pembaruan roadmap strategis
5. **Follow-up Items**: Daftar tindak lanjut kritis

## Kriteria Sukses

- Semua keputusan strategis didukung oleh data dan analisis yang solid
- Arahan ke agen lain jelas dan actionable
- Visi perusahaan terkomunikasikan dengan konsisten
- Performa perusahaan meningkat secara berkelanjutan
- Semua agen aligned dengan strategi keseluruhan

## Monitoring dan Evaluasi

- Track KPI perusahaan secara harian
- Monitor implementasi arahan strategis
- Evaluasi kualitas keputusan yang dibuat
- Assessment alignment seluruh organisasi
- Review efektivitas komunikasi eksekutif
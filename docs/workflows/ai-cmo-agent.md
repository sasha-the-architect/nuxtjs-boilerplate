# AI CMO Agent Workflow

## File Konfigurasi
**Nama File**: `.github/workflows/ai-cmo-agent.yml`

## Deskripsi
CMO Agent adalah agen AI yang bertindak sebagai Chief Marketing Officer untuk startup AI. Agen ini bertanggung jawab atas strategi pemasaran, branding, customer acquisition, dan growth marketing.

## Jadwal Eksekusi
- **Waktu**: 11:00 UTC setiap hari
- **Frekuensi**: Harian
- **Prioritas**: Sedang
      ...
      - name: Run CMO Agent
        ...
        run: |
          opencode run "$(cat <<'PROMPT'
            ...
            Alasan: Kemampuan analisis visual untuk creative assets, pemahaman multi-channel marketing, dan kemampuan strategis untuk brand positioning.
...
1. **Marketing Performance Report**: Laporan komprehensif metrik pemasaran
2. **Campaign Optimization Plan**: Rencana optimasi kampanye aktif
3. **Content Calendar**: Kalender konten yang terstruktur
4. **Market Intelligence Summary**: Insight pasar dan analisis kompetitif
5. **Marketing Strategy Updates**: Pembaruan strategi pemasaran berdasarkan performa

## Kriteria Sukses

- Brand awareness dan equity terus meningkat
- Customer acquisition cost teroptimasi
- Marketing ROI positif dan meningkat
- Multi-channel marketing strategy terintegrasi
- Customer journey dan experience dioptimasi

## Monitoring dan Evaluasi

- Track marketing KPI (CAC, CLV, conversion rates, brand awareness)
- Monitor campaign performance dan ROI
- Evaluasi content engagement dan effectiveness
- Assessment market share dan competitive positioning
- Review effectiveness marketing strategies dan initiatives
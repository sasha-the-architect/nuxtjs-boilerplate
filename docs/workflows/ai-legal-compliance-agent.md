# AI Legal & Compliance Agent Workflow

## File Konfigurasi
**Nama File**: `.github/workflows/ai-legal-compliance-agent.yml`

## Deskripsi
Legal & Compliance Agent adalah agen AI yang bertindak sebagai Head of Legal & Compliance untuk startup AI. Agen ini bertanggung jawab atas kepatuhan regulasi, manajemen risiko hukum, dan perlindungan perusahaan.

## Jadwal Eksekusi
- **Waktu**: 16:30 UTC setiap hari
- **Frekuensi**: Harian
- **Prioritas**: Sedang
      ...
      - name: Run Legal & Compliance Agent
        ...
        run: |
          opencode run "$(cat <<'PROMPT'
            ...
            Alasan: Kemampuan analisis legal yang baik, pemahaman compliance requirements, dan kemampuan implementasi legal frameworks yang sistematis.
...
1. **Compliance Status Report**: Laporan status kepatuhan regulasi
2. **Regulatory Update Summary**: Ringkasan perubahan regulasi terkini
3. **Contract Review Status**: Status review dan manajemen kontrak
4. **Risk Assessment Update**: Update assessment risiko hukum
5. **Legal Advisory Summary**: Ringkasan advisori legal dan guidance

## Kriteria Sukses

- Regulatory compliance terjaga 100%
- Legal risks diminimalkan dan dikelola dengan baik
- Contracts efektif dan melindungi kepentingan perusahaan
- IP protection strategy kuat dan terimplementasi
- Data privacy dan security compliance terjamin

## Monitoring dan Evaluasi

- Track compliance metrics dan audit results
- Monitor regulatory change impact assessment
- Evaluasi contract performance dan risk exposure
- Assessment effectiveness legal risk mitigation
- Review legal support quality dan responsiveness
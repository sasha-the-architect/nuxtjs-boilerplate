# AI Customer Success Agent Workflow

## File Konfigurasi
**Nama File**: `.github/workflows/ai-customer-success-agent.yml`

## Deskripsi
Customer Success Agent adalah agen AI yang bertindak sebagai Customer Success Manager untuk startup AI. Agen ini bertanggung jawab atas kepuasan pelanggan, retensi, dan pengembangan hubungan pelanggan.

## Jadwal Eksekusi
- **Waktu**: 15:30 UTC setiap hari
- **Frekuensi**: Harian
- **Prioritas**: Sedang
      ...
      - name: Run Customer Success Agent
        ...
        run: |
          opencode run "$(cat <<'PROMPT'
            ...
            Alasan: Kemampuan analisis customer data yang baik, pemahaman customer relationship management, dan kemampuan komunikasi yang efektif.
...
1. **Customer Health Dashboard**: Dashboard kesehatan pelanggan terkini
2. **Support Issues Summary**: Ringkasan isu support dan resolusi
3. **Customer Insights Report**: Laporan insight dari feedback pelanggan
4. **Proactive Engagement Plan**: Rencana engagement proaktif
5. **Success Stories Collection**: Kumpulan success stories dan testimonials

## Kriteria Sukses

- Customer satisfaction dan NPS tinggi dan meningkat
- Churn rate rendah dan terkontrol
- Customer feedback diintegrasikan ke product development
- Proactive engagement mengurangi issues
- Customer advocacy dan references berkembang

## Monitoring dan Evaluasi

- Track customer satisfaction metrics (NPS, CSAT, CES)
- Monitor retention dan churn rates
- Evaluasi effectiveness proactive engagement
- Assessment feedback integration ke product
- Review customer success initiative impact
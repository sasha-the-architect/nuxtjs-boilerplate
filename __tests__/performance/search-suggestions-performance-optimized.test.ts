...
describe('Search Suggestions Performance: Optimized O(k) Tag/Category Scanning', () => {
  ...
  it('should measure optimized performance for short queries', () => {
  ...
  it('should measure optimized performance for long queries', () => {
    const suggestions = useSearchSuggestions(resources)
    const iterations = 100
  ...
  it('should measure optimized performance for exact resource match', () => {
    const suggestions = useSearchSuggestions(resources)
    const iterations = 100
